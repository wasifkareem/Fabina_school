  ...
  return (
    <div>
      <div className="  ">
        ...
        >
          {({ errors, touched }) => (
            <Form className=" mb-4 rounded sm:w-1/3 border-black border sm:ml-[450px] sm:py-8   float-left  sm:mt-20 w-[93%] pb-3 ml-3 flex flex-col  bg-white">
              <p className=" sm:text-lg font-semibold sm:mr-3 ml-4 mt-2 sm:ml-5  text-gray-100  bg-red-600 w-fit px-3 rounded  ">
                Course Details.
              </p>
              <Field
                className="focus:outline-none rounded-lg  mx-3 mt-4 px-4 sm:mx-10 py-2 mb-2 border border-gray-300"
                id="title"
                name="title"
                placeholder="title"
              />
              ...
              <MyTextArea
                className="focus:outline-none rounded-lg  mx-3 h-24 px-4 sm:mx-10 py-2 mb-2 border border-gray-300"
                id="desc"
                name="desc"
                placeholder="desc"
              />
              ...
              <Field
                className="focus:outline-none rounded-lg  mx-3 px-4 sm:mx-10 py-2 mb-2 border border-gray-300"
                id="img"
                name="img"
                placeholder="img"
                type="img"
